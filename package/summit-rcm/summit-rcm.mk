...
SUMMIT_RCM_SITE = $(BR2_EXTERNAL_SUMMIT_SOM_PATH)/externals/summit-rcm
SUMMIT_RCM_SITE_METHOD = local
SUMMIT_RCM_LICENSE = Ezurio
SUMMIT_RCM_LICENSE_FILES = LICENSE.ezurio
SUMMIT_RCM_SETUP_TYPE = pep517
SUMMIT_RCM_DEPENDENCIES = openssl python3

ifeq ($(BR2_PACKAGE_HOST_PYTHON_CYTHON),y)
SUMMIT_RCM_DEPENDENCIES += host-python-cython
HOST_SUMMIT_RCM_DEPENDENCIES += host-python-cython
endif
