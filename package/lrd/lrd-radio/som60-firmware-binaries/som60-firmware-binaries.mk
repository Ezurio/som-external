...
SOM60_FIRMWARE_BINARIES_EXTRA_DOWNLOADS = laird-60-radio-firmware-sdio-uart-$(SOM60_FIRMWARE_BINARIES_VERSION).tar.bz2

ifeq ($(MSD_BINARIES_SOURCE_LOCATION),laird_internal)
  SOM60_FIRMWARE_BINARIES_SITE = https://$(RFPROS_FILESHARE_AUTH)files.devops.rfpros.com/builds/linux/firmware/$(SOM60_FIRMWARE_BINARIES_VERSION)
else
