...
LIBOPENSSL_3_0_TARGET_ARCH = $(call qstrip,$(BR2_PACKAGE_LIBOPENSSL_TARGET_ARCH))
...
LIBOPENSSL_3_0_CFLAGS += -U_FORTIFY_SOURCE -O0 -g3
endif

ifeq ($(BR2_ARM_INSTRUCTIONS_THUMB),y)
LIBOPENSSL_3_0_CFLAGS += -marm
endif

ifeq ($(BR2_PACKAGE_LIBOPENSSL_ENABLE_COMP),y)
...
ifeq ($(BR2_PACKAGE_LIBOPENSSL_ENABLE_FIPS),y)
LIBOPENSSL_3_0_FIPS_EXT_PATCH_DIR=$(BR2_EXTERNAL_SUMMIT_FIPS_DEVEL_PATH)/externals/summitssl_patches/openssl-3.0-fips-patches/libopenssl_3_0
