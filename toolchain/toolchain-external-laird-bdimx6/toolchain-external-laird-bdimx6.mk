...
TOOLCHAIN_EXTERNAL_LAIRD_BDIMX6_VERSION = 11.0.0.131
TOOLCHAIN_EXTERNAL_LAIRD_BDIMX6_SOURCE = bdimx6_toolchain-laird-$(TOOLCHAIN_EXTERNAL_LAIRD_BDIMX6_VERSION).tar.gz

ifeq ($(MSD_BINARIES_SOURCE_LOCATION),laird_internal)
TOOLCHAIN_EXTERNAL_LAIRD_BDIMX6_SITE = https://$(RFPROS_FILESHARE_AUTH)files.devops.rfpros.com/builds/linux/toolchain/$(TOOLCHAIN_EXTERNAL_LAIRD_BDIMX6_VERSION)
else
